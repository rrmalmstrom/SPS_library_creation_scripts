...
# # make df of project_summary.db with a subset of columns related to pools
passed_df = readSQLdb()

passed_df = passed_df[['Library Name','Pool_source_plate', 'Pool_source_well', 'Pool_Illumina_index_set', 'Pool_Illumina_index','Pool_dilution_factor','Pool_nmole/L']]
