...
def makeBarcodeLabels(wp_redo_df, dest_list):
    ...
    bc_file = open("labels_Redo_Library_FA_plates.txt", "w")
    ...
    Path(FIRST_DIR / "labels_Redo_Library_FA_plates.txt").rename(SECOND_ATMPT_DIR / "labels_Redo_Library_FA_plates.txt")
...
def makeDilution(wp_redo_df):
    dilution_df = wp_redo_df[['Redo_Destination_ID','Redo_Destination_Well','Redo_FA_Well']].copy()
