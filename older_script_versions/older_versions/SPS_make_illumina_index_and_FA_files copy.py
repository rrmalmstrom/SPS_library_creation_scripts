...
def makeThreshold(final_df, dest_list):
    ...
    thresh_df.columns=['Destination_plate']
...
def makeDilution(final_df):
    dilution_df = final_df[['Destination Plate Barcode','Destination_Well','FA_Well']].copy()
    ...
    # rearrange column order
    dilution_column_list = ['Library_Plate_Barcode','Library_Well','FA_Plate_Barcode',	'FA_Well',	'Nextera_Vol_Add',	'FA_Vol_Add']
