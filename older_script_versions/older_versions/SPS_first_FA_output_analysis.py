...
def findPassFailLibs(my_lib_df, my_dest_plates):
    ...
    my_lib_df = my_lib_df.merge(thresh_df, how='outer', left_on=[
        'Destination Plate Barcode'], right_on=['Destination_plate'])
...
reduced_fa_df = fa_summary_df[['sample_id', 'Destination Plate Barcode', 'FA_Well', 'ng/uL', 'nmole/L', 'Avg. Size', 'Passed_library', 'Redo_whole_plate']].copy()
